...
|__/     |__/|________/|__/  |__/|__/  |__/|__/  |__/
 ...
 \33[1;32m ----------------------------------------------- 
 \33[1;32m OWNER :→⁠_⁠→>>>> AN9ND M3HR9 <<<<K1NG£®
 \33[1;32m FACEBOOK : https://www.facebook.com/9n9ndm3hr9.c0m
 \33[1;32m NUMBER : +91 7643890543 
...
def sendtextconvo(comment): 
     ...
     print(">> A9ND M3HR9 K1NG$® >>> :: ", yyy+ ' ' +line, "\n") 
  
print("\033[1;33;40m", end = "") 
os.system('clear') 
print(logo) 
sp("\033[1m\033[36m[+] EM9IL D9L 9UR 9N9ND P9P9 BOL \n") 
print(47*'\33[1;36m-') 
